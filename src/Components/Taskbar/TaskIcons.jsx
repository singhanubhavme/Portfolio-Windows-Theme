            ...
            <div className="icons flex flex-row justify-center items-center text-center">
                ...
                <Fragment>
                    <Menu as="div" className="relative inline-block text-center">
                        <div>
                            <Menu.Button >
                                <Image src={ArrowIcon} className="w-4 m-1.5" alt="arrow icon" aria-hidden='true' />
                            </Menu.Button>
                        </div>
                                ...
                                <div className="py-1">
                                    <Menu.Item>
                                        {({ active }) => (
                                            <button
                                                className={
                                                    (active ? 'text-white' : 'text-white') + ' block px-4 py-2 text-sm'
                                                }
                                            >
                                                Hey There!!
                                            </button>
                ...
                <Image src={BatteryIcon} className="w-6 m-1.5" style={{ filter: 'invert(100%)' }} alt="battery icon" />
                <Image src={SoundIcon} className="w-6 h-6 m-1.5" alt="sound icon" style={{ filter: 'invert(100%)' }} />
            </div>
        </Fragment>
    );
}
