          ...
          <div className="relative h-[85%] w-[70%]">
            ...
            <div>
              <div class="w-full rounded-lg bg-gray-800">
                <div class="w-full rounded bg-gray-900 p-8 shadow">
                  ...
                  <form action="" method="post">
                    ...
                    <div>
                      <div class="mt-8 flex w-full flex-col">
                        ...
                        <textarea
                          type="text"
                          class="mt-4 h-40 resize-none rounded border-0 bg-gray-800 p-3 text-base leading-none text-gray-50 focus:border-blue-700 focus:outline-none"
                        ></textarea>
                      </div>
                    </div>
                    <div class="flex w-full items-center justify-center">
                      <button class="mt-9 rounded bg-blue-700 px-10 py-4 font-semibold leading-none text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-700 focus:ring-offset-2">
                        Send message
                      </button>
                    </div>
                  </form>
